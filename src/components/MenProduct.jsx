...
export default function MenProduct(props) {
    ...
    useEffect(() => {
        axios.get(`https://riser-backend.onrender.com/products/get-products/men`).then((res) => {
    ...
    function handleSubmit(e) {
        ...
        axios.post(`https://riser-backend.onrender.com/products/get-products/filters-men`, payload).then((res) => {
            setProducts(res.data.products)
        }).catch((err) => {
            console.log(err)
        })
